// Path fixed for the flattened dev4-vendor/ layout (originally
// '../shared/constants.js', relative to content/confirmationUI.js in Dev
// 4's own tree — that file is Dev 4's own shared/constants.js, vendored
// alongside this one as ./constants.js). Logic is unchanged.
import { RISK_TIERS } from './constants.js';
